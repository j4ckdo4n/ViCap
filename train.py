...
from transformers import (
    AdamW,get_linear_schedule_with_warmup, set_seed,MBartForConditionalGeneration)
...
def training_function(config):
    ...
    for epoch in range(epochs):
        ...
        for idx, (tokens, mask, prefix) in enumerate(train_dataloader):
            ...
            # print(tokens.shape, mask.shape, prefix.shape)
            # print(tokens)
            # print(prefix)
            # print(mask)
            #exit()
...
def main():
    ...
    parser.add_argument("--batch-size", type=int, default=8, help="Batchsize, 64 for V38, 32 for V28, and 16 for P100")
