...
vtokenizer = AutoTokenizer.from_pretrained("NlpHUST/gpt2-vietnamese")
...
data = json.load(open("viecap4h-public-train/train_captions.json"))
train, val = train_test_split(data, test_size=0.1, random_state=42)
public_test = json.load(open("vietcap4h-public-test/sample_submission.json", "r"))
...
create_dataset(train, "viecap4h-public-train/images_train/", "train_img_b16.pt")
create_dataset(val, "viecap4h-public-train/images_train/", "val_img_b16.pt")
create_dataset(public_test, "vietcap4h-public-test/images_public_test/", "test_public_b16.pt")
